export async function createCustomerController(req: any, res: any) {
    try {
      ...
      // Make sure address is less than 100 characters
      ...
      // When a user makes a new account, you want to make sure the email is recognized
      // You turn it into lowercase first so the database recognises it
